...
RESULT_DIR = "results" # 결과 저장 폴더 설정

@app.post("/analyze")
async def analyze_video(file: UploadFile = File(...)):
    # [1] 앱에서 보낸 영상 임시 저장 (분석을 위해 파일로 저장)
    ...
    output_path = os.path.join(daily_dir, f"{video_name}_result.mp4")
    ...
    # [3] AI 분석 루프 (개/고양이 전용 인식 적용)(추후 세밀하게 조정할 예정)
    while cap.isOpened():
    ...
    return {
        ...
        "anomaly_found": anomaly_detected,
